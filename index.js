...
function loadFullData(){
  ...
  json.results.forEach(function(data){
    var table = document.getElementById('planetresult');
  ...
  if(searchValue == ''){
    ...
    json.results.forEach(function(data){
      if(data.name.toLowerCase().includes(searchValue.toLowerCase())){
        ...
        // document.getElementById('planet').innerHTML = '<tr><td>Tidak ketemu</td></tr>'
      } 
    })
  }
}